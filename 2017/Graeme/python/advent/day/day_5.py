...
class Day5:
    ...
    @staticmethod
    def steps_to_escape(maze: list, decrement_above: int=None) -> int:
        """
        ...
        :param maze: List to escape
        :param decrement_above: If offset is above this value, decrement value in list
